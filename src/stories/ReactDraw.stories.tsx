...
export const Playground: StoryObj<typeof ReactDraw> = {
  args: {
    drawingTools,
    actionTools,
...
export const FreeDrawOnly: StoryObj<typeof ReactDraw> = {
  args: {
...
export const SaveAndLoadJson: StoryObj<typeof ReactDraw> = {
  args: {
    drawingTools,
    shouldSelectAfterCreate: true,
...
export const ExternalControls: StoryObj<typeof ReactDraw> = {
...
export const CustomizeStyles: StoryObj<typeof ReactDraw> = {
  args: {
    drawingTools,
    actionTools,
