...
export default {
  title: "Customization Examples/Save And Load Canvas JSON",
};
...
export const SaveAndLoadCanvasJSON = Template.bind({});

SaveAndLoadCanvasJSON.args = {
  topBarTools,
...
SaveAndLoadCanvasJSON.parameters = {
  docs: {
    source: {
      code: `
import {
